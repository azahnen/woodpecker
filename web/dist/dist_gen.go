...
var files = map[string]file{
	"/favicon.svg": {
		...
		FileInfo: &fileInfo{
			name:    "favicon.svg",
			size:    1728,
			modTime: time.Unix(1612521358, 0),
		},
	},
	"/index.html": {
		data: file1,
	...
	"/static/bundle.3cb4ce3a39b92be8789e.js": {
		data: file2,
		FileInfo: &fileInfo{
			name:    "bundle.3cb4ce3a39b92be8789e.js",
			size:    385973,
			modTime: time.Unix(1612521358, 0),
		},
	},
	"/static/vendor.80e0fa3ffb8dbe2c95f0.js": {
		data: file3,
		FileInfo: &fileInfo{
			name:    "vendor.80e0fa3ffb8dbe2c95f0.js",
			size:    272277,
			modTime: time.Unix(1612521358, 0),
		},
	},
...
<body>
<script type="text/javascript" src="/static/vendor.80e0fa3ffb8dbe2c95f0.js"></script><script type="text/javascript" src="/static/bundle.3cb4ce3a39b92be8789e.js"></script></body>
</html>
`)
...
var fetchBuild = exports.fetchBuild = function fetchBuild(tree, client, owner, name, number) {
  ...
  client.getBuild(owner, name, number).then(function (build) {
    var path = ["builds", "data", slug, number];
...
var RepoMenu = function (_Component) {
  ...
  RepoMenu.prototype.render = function render() {
    ...
    var menu = user && user.data ? [{ to: "/" + owner + "/" + repo, label: "Builds" }, { to: "/" + owner + "/" + repo + "/settings/secrets", label: "Secrets" }, { to: "/" + owner + "/" + repo + "/settings/registry", label: "Registry" }, { to: "/" + owner + "/" + repo + "/settings", label: "Settings" }] : [{ to: "/" + owner + "/" + repo, label: "Builds" }];
          ...
          _react2["default"].createElement(
            ...
            _react2["default"].createElement(_reactRouterDom.Route, {
              ...
              component: function component(props) {
                return _react2["default"].createElement(_menu8["default"], _extends({}, props, { user: user }));
              }
            })
          )
        ),
...
var Sidebar = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
  ...
  Sidebar.prototype.render = function render() {
    ...
    return _react2["default"].createElement(
      ...
      LOGO,
      starred && starred.length > 0 && _react2["default"].createElement(
...
var binding = function binding(props, context) {
  ...
  var slug = owner + "/" + repo;
  var number = build === "latest" ? build : parseInt(build);
...
var BuildLogs = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
  ...
  BuildLogs.prototype.render = function render() {
    ...
    var _props$match$params2 = this.props.match.params,
        owner = _props$match$params2.owner,
        repoName = _props$match$params2.repo,
        buildId = _props$match$params2.build;


    if (buildId === "latest" && build && build.id) {
      return _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + owner + "/" + repoName + "/" + build.id });
    }
...
var BuildLogsTitle = exports.BuildLogsTitle = function (_Component2) {
  ...
  BuildLogsTitle.prototype.render = function render() {
    var _props$match$params3 = this.props.match.params,
        owner = _props$match$params3.owner,
        repo = _props$match$params3.repo,
        build = _props$match$params3.build;
...
var BuildMenu = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
  ...
  BuildMenu.prototype.render = function render() {
    ...
    var rightSide = !build || !user || !user.data ? undefined : _react2["default"].createElement(
      "section",
      null,
